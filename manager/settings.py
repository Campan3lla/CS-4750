...
SECRET_KEY = 'django-insecure-8@#l)=!bth_b1s-2dxig7i#bnoi(l6usmp%e0nt5nxn$=anzo1'
...
# ACCOUNT: any settings to do with accounts and the login process
AUTH_USER_MODEL = 'website.UniversityMember'
